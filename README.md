...
**JP: Woori FISA クラウドエンジニアリング課程 第6期 学習記録**  

### 📝 Learning Journey Status

```Plain text
Course Status    : 🟢 In Progress (Since Dec 30, 2025)
Content Coverage : ✅ Feb 25, 2026 (Server Virtualization Day 02)
Upcoming Content : 🔜 Server Virtualization Day 03 - 04
Last Updated     : ☑️ Feb 27, 2026
```
...
**학습 내용 정리 및 복습 기록**  
**EN: Learning Summaries and Review Records**  
**JP: 学習内容の整理および復習の記録**  

```Plain Text
🟢 : 작성 완료 / Completed / 作成完了
🟠 : 작성 진행 / In Progress / 作成中
🔴 : 작성 대기 / Pending / 作成待機
```

## 1. Environment & Setup

**클라우드 엔지니어링 실습을 위한 인프라 및 개발 환경 구축 기록**  
...
**교육 과정 핵심 기술 및 개념 요약**  
**EN: Summary of Key Technical Concepts in the Curriculum**  
**JP: カリキュラム核心技術および概念の要約**  
...
| 🟢 | Jan 29, 2026 | [JPA Mission](./03_Lectures_Summary/01_Web_Service/Web/[2026.01.29]_JPA_Mission.md) |
...
|  | Date | Title | 
| :---: | :--- | :--- |
| 🟢 | Feb 24, 2026 | [Server Virtualization Day 01](./03_Lectures_Summary/02_Infra_System/Server_Virtualization/[2026.02.24]_I_Server_Virtualization_Day_01.md) |
